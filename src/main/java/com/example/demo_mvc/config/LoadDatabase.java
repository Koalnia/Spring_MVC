...
class LoadDatabase {
    ...
    public CommandLineRunner loadData() {
        return (args) -> {
            ...
            users.add(new User("Mateusz Rykała","123456789","admin1@pl",passwordEncoder.encode("Hasloha11!"),Set.of(Role.ADMIN.toString())));

            users.add(new User("Anna Kowalska", "111222333", "anna.kowalska@gmail.com", passwordEncoder.encode("Password123!"), Set.of(Role.ADMIN.toString())));
            users.add(new User("Jan Nowak", "444555666", "jan.nowak@gmail.com", passwordEncoder.encode("Qwerty456!"), Set.of(Role.ADMIN.toString())));
            users.add(new User("Katarzyna Wiśniewska", "607456789", "kasia.w@gmail.com", passwordEncoder.encode("SecurePass789!"), Set.of(Role.USER.toString())));
            users.add(new User("Tomasz Zieliński", "+48123456789", "t.zielinski@gmail.com", passwordEncoder.encode("Pass1234!"), Set.of(Role.USER.toString())));
            users.add(new User("Joanna Lewandowska", "444555789", "joanna.lew@gmail.com", passwordEncoder.encode("Joanna2023!"), Set.of(Role.USER.toString())));
            users.add(new User("Michał Nowicki", "888999000", "michal.nowicki@gmail.com", passwordEncoder.encode("Micha12345!"), Set.of(Role.USER.toString())));
            users.add(new User("Agnieszka Kaczmarek", "999000111", "agnieszka.k@gmail.com", passwordEncoder.encode("Agnieszka2024!"), Set.of(Role.USER.toString())));
            users.add(new User("Piotr Wiśniewski", "666777888", "piotr.w@gmail.com", passwordEncoder.encode("PiotrPass!"), Set.of(Role.USER.toString())));
            users.add(new User("Ewa Majewska", "+48123123123", "ewa.majewska@gmail.com", passwordEncoder.encode("EwaMaj12!"), Set.of(Role.USER.toString())));
